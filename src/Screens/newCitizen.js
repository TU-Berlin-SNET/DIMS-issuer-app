...
class newUserScreen extends Component {
  constructor(props){
    ...
    this.state={
      ...
      did: "",
      profilePictureSrc: props.location.state.person !== undefined && props.location.state.person.picture !== undefined ? props.location.state.person.picture : null, 
      base64ProfilePic: props.location.state.person !== undefined && props.location.state.person.picture !== undefined? props.location.state.person.picture : "" ,   
      snackbarOpen: false,
      snackbarMessage: "",
